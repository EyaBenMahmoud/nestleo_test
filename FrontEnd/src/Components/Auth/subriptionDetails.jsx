...
import { FaBuilding, FaCalendarAlt, FaCrown } from 'react-icons/fa';
import { Link } from 'react-router-dom';
import Plans from '../../pages/Landing/OnePage/plans'; // Import the Plans component
//i18n
...
const SubscriptionDetails = (props) => {
  ...
  const filteredData = allSubscriptions.filter(sub => {
    ...
    if (activeTab === 'current') {
      return matchesSearch && sub === user?.subscription;
    } else {
      return matchesSearch && sub !== user?.subscription;
    }
  });
  ...
  const currentSubscriptions = filteredData.slice(indexOfFirstItem, indexOfLastItem);
                  ...
                  <Nav tabs className="nav-tabs-custom rounded card-header-tabs border-bottom-0 mb-4">
                    ...
                    <NavItem>
                      ...
                      >
                        ...
                        <span className="badge bg-secondary ms-1">{allSubscriptions.length - 1}</span>
                      </NavLink>
                    </NavItem>
                    <NavItem>
                      <NavLink
                    ...
                    <TabPane tabId="current">
                      {currentSubscriptions.length > 0 ? (
                        ...
                        <div className="text-center py-5">
                          ...
                          {activeTab === 'history' && <p className="text-muted mb-0">{t('subscription.noHistory')}</p>}
                        </div>
                      )}
