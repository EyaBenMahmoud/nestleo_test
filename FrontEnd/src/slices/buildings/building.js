...
const initialState = {
    ...
    ownerApartments: [], // Apartments owned by the logged-in user
...
// Export Actions
export const { resetCoOwners, clearSelectedBuilding, SetCurrentBuilding, clearCurrentBuilding, clearBuildingError, clearBuildingMessage } = buildingSlice.actions;
