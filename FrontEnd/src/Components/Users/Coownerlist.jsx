...
const Coownerlist = () => {
    ...
    const SyndicateCoownerData = list.filter(user => user.role === "SyndicateCoowner");
    const filteredData = SyndicateCoownerData.filter(
        item =>
        ...
        <Container fluid style={{ marginTop: "80px" }}>
            <Row>
                <Col lg={12}>
                    <Card>
                        <CardHeader>
                            <h4 className="card-title mb-0">Co-Owners Accounts Management</h4>
                        </CardHeader>
                        ...
                        <CardBody>
                            ...
                            <DataTable
                                ...
                                responsive
                                striped
                                noDataComponent={<div className="py-4">No Co-Owner found</div>}
                            />
                        </CardBody>
                    </Card>
                </Col>
