...
const NotificationDropdown = () => {
    ...
    const alertNotifications = notifications.filter(n => n.type === 'alert' || n.type === 'system' || n.type === 'info' || n.type === 'success');
    ...
    navigate('/review');
    setIsNotificationDropdown(false);
  }else if ((notification.type === 'info' || notification.type === 'success') && notification.onModel === 'User') {
    // Handle account transfer notifications
                                            ...
                                            <div className="d-flex">
                                                <div className="avatar-xs me-3">
                                                    {notification.gamification ? (
                                                        ...
                                                        // Regular alert icon
                                                        <span className={`avatar-title bg-soft-${
                                                            ...
                                                            <i className={
                                                                notification.type === 'alert' ? 'bx bx-error-circle' : 
                                                                notification.type === 'info' ? 'bx bx-info-circle' : 
                                                                notification.type === 'success' ? 'bx bx-check-circle' : 
                                                                notification.type === 'system' ? 'bx bx-bell' : 'bx bx-badge-check'
                                                            }></i>
                                                        </span>
                                                    )}
                                                </div>
