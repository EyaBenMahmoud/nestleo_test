...
const InvoiceEditModal = ({ isOpen, toggle, invoiceId, onSuccess, currentBuilding }) => {
    ...
    const validateItems = useCallback((items) => {
        ...
        // Only set errors temporarily for submission validation
        if (hasErrors) {
                                ...
                                <Col md={6}>
                                    <FormGroup>
                                        ...
                                        <Select
                                            ...
                                            onChange={handleApartmentChange}  // Add the onChange handler
                                            placeholder={t("invoices.create.selectApartments")}
                                            classNamePrefix="select"
                                            isDisabled={!selectedCoowner}  // Only disable if no co-owner selected
                                        />
                                        {!selectedCoowner && (
