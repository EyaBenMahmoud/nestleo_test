                    ...
                    <TabPane tabId={activeTab}>
                      {loading ? (
                        ...
                        <div className="text-center py-5">
                          ...
                          {filterText ? (
                            <p className="text-muted mb-0">{t('claims.noMatchesFound')} "{filterText}"</p>
                          ) : statusFilter !== 'all' || activeTab !== 'all' ? (
                            <p className="text-muted mb-0">{t('claims.noClaimsWithFilter')}</p>
                          ) : !currentBuilding ? (
                            <p className="text-muted mb-0">{t('claims.selectBuilding')}</p>
                          ) : (
                            <p className="text-muted mb-0">{t('claims.noClaimsYet')}</p>
                          )}
