...
const SyndicateAdmin = () => {
    ...
    const SyndicateAdminData = list.filter(user => user.role === "SyndicateAdmin");
    const filteredData = SyndicateAdminData.filter(
        item =>
        ...
        <Container fluid style={{ marginTop: "80px" }}>
            <Row>
                <Col lg={12}>
                    <Card>
                        <CardHeader>
                            <h4 className="card-title mb-0">Syndicate Admin Management</h4>
                        </CardHeader>
                        ...
                        <CardBody>
                            ...
                            <DataTable
                                ...
                                responsive
                                striped
                                noDataComponent={<div className="py-4">No Syndicate Admins found</div>}
                            />
                        </CardBody>
                    </Card>
                </Col>
