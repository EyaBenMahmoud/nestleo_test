...
const Navdata = () => {
    ...
    const [isMeetingManagement, setIsMeetingManagement] = useState(false); // New state for Meeting Management
    ...
    useEffect(() => {
        ...
        if (iscurrentState !== 'MeetingManagement') {
            setIsMeetingManagement(false);
        }
    ...
    const menuItems = [
        ...
        },
        {
            ...
            roles: ["SyndicateAdmin"],
            stateVariableName: "isMeetingManagement",
            click: function (e) {
                e.preventDefault();
                setIsMeetingManagement(!isMeetingManagement);
                setIscurrentState('MeetingManagement');
                updateIconSidebar(e);
            },
            subItems: [
                {
                    ...
                    label: "Calendar",
                    link: "/calendar",
                    parentId: "MeetingManagement",
                },
                {
                    id: "Votes",
                    label: "Votes",
                    link: "/votesmanagement",
                    parentId: "MeetingManagement",
                },
            ],
        },
