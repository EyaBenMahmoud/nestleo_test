...
const Calendar = ({ t }) => {
  ...
  const { events = [], loading, error, successMessage } = useSelector((state) => state.events || {});
      ...
      start: Yup.date()
        ...
        .min(
          ...
          .matches(/^([01]?[0-9]|2[0-3]):[0-5][0-9]$/, {
            message: t('calendar.errors.invalidEventTime'),
    ...
    <React.Fragment>
      ...
      <div className="page-content">
        ...
        <Container fluid >
          ...
          {timeConflictError && (
            <div className="time-conflict-alert alert alert-danger mt-2">
              <i className="ri-error-warning-line me-1"></i>
              <strong>{t('calendar.timeConflict')}</strong>
              <div>{t('calendar.chooseAnotherTime')}</div>
            </div>
          )}
          <Row>
            <Col xs={12}>
                        ...
                        <div className="calendar-legend-container">
                          ...
                          <div className="calendar-event-legend">
                            ...
                            <div className="calendar-legend-item delegate-legend">
                              ...
                              <span className="legend-label">{t('calendar.eventTypeDelegate') || 'Delegate Events'}</span>
                            </div>
                          </div>
                        </div>
                      </CardBody>
                  ...
                  {event && event.title ? (
                    <Row>
                      ...
                      <Col lg={4}>
                        ...
                        {!event.type && (
                          <div className="poll-manager-section">
                            <EventPollManager eventId={event._id} />
                          </div>
                        )}
                      </Col>
                    </Row>
