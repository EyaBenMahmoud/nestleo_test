        ...
        <React.Fragment>
            <Dropdown isOpen={isProfileDropdown} toggle={toggleProfileDropdown} className={classname}>
                ...
                <DropdownMenu className="dropdown-menu-end">
                    ...
                    <DropdownItem className='p-0'>
                        <Link to={process.env.PUBLIC_URL + "/poll-management"} className="dropdown-item">
                            <i className="mdi mdi-archive text-muted fs-16 align-middle me-1"></i>
                            <span className="align-middle">{t('profileDropdown.archivedPolls')}</span>
                        </Link>
                    </DropdownItem>
