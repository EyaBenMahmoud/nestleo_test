...
const BuildingInterface = ({ t }) => {
    ...
    const filteredBuildings = buildings.filter(building => {
        ...
        // Place selected building first
        if (currentBuilding && currentBuilding._id === a._id) return -1;
        if (currentBuilding && currentBuilding._id === b._id) return 1;
        return 0;
    });
                            ...
                            <Row>
                                {currentBuildings.map((building) => (
                                    <Col xxl={4} xl={6} md={6} className="mb-4" key={building._id}>
                                        <Card className={`building-card card-height-100 ${currentBuilding && currentBuilding._id === building._id ? 'selected-building' : ''}`}>
                                    ...
                                    {currentBuilding && currentBuilding._id === building._id && (
                                        <div className="d-flex gap-1">
                                            <button
                                                ...
                                                title={t('buildings.editDisabled')}
                                            >
                                            ...
                                            <button
                                                ...
                                                title={t('buildings.deleteDisabled')}
                                            >
...
/* Selected building styles */
.building-card.selected-building {
  border: 2px solid #3a57e8;
  box-shadow: 0 8px 24px rgba(58, 87, 232, 0.25);
  background: linear-gradient(135deg, rgba(58, 87, 232, 0.02) 0%, rgba(58, 87, 232, 0.05) 100%);
}

.building-card.selected-building .card-header {
  background: linear-gradient(135deg, rgba(58, 87, 232, 0.1) 0%, rgba(58, 87, 232, 0.15) 100%) !important;
  border-bottom: 1px solid rgba(58, 87, 232, 0.2);
}

.building-card.selected-building .card-title {
  color: #3a57e8;
  font-weight: 600;
}
